...
(function (factory) {
  ...
  $.fn.extend({
    ...
    summernote: function () {
      ...
      options.tooltip =
        options.tooltip === "auto" ? !agent.isSupportTouch : options.tooltip;
      ...
      context.memo("button.underline", function () {
        return ui
          .button({
            ...
            click:
              context.createInvokeHandlerAndUpdateState("editor.underline"),
          })
          .render();
      });
      ...
      context.memo("button.strikethrough", function () {
        return ui
          .button({
            ...
            tooltip:
              lang.font.strikethrough + representShortcut("strikethrough"),
      ...
      context.memo("button.superscript", function () {
        return ui
          .button({
            ...
            click:
              context.createInvokeHandlerAndUpdateState("editor.superscript"),
          })
          .render();
      });
      ...
      context.memo("button.subscript", function () {
        return ui
          .button({
            ...
            click:
              context.createInvokeHandlerAndUpdateState("editor.subscript"),
          })
          .render();
      });
        ...
        return ui
          .buttonGroup([
            ...
            ui.dropdownCheck({
              ...
              click:
                context.createInvokeHandlerAndUpdateState("editor.fontName"),
            }),
          ])
          .render();
      });
        ...
        return ui
          .buttonGroup([
            ...
            ui.dropdownCheck({
              ...
              click:
                context.createInvokeHandlerAndUpdateState("editor.fontSize"),
            }),
          ])
          .render();
      });
      ...
      context.memo("button.ul", function () {
        return ui
          .button({
            ...
            tooltip:
              lang.lists.unordered + representShortcut("insertUnorderedList"),
      ...
      context.memo("button.ol", function () {
        return ui
          .button({
            ...
            tooltip:
              lang.lists.ordered + representShortcut("insertOrderedList"),
    ...
    this.build = function ($container, groups) {
      for (
        ...
        for (var idx = 0, len = buttons.length; idx < len; idx++) {
          ...
          if (button) {
            $group.append(
              typeof button === "function" ? button(context) : button,
            );
          }
        }
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      if (options.maximumImageFileSize) {
        ...
        var readableSize =
          (options.maximumImageFileSize / Math.pow(1024, unit)).toFixed(2) * 1 +
          " " +
          " KMGTP"[unit] +
          "B";
        imageLimitation =
      ...
      return Object.keys(keyMap)
        .map(function (key) {
          ...
          $row
            ...
            .append(
              $("<span/>").html(context.memo("help." + command) || command),
            );
          return $row.html();
        })
        .join("");
  ...
  var HintPopover = function (context) {
    ...
    this.handleKeyup = function (e) {
      if (
        list.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)
      ) {
        if (e.keyCode === key.code.ENTER) {
          if (this.$popover.is(":visible")) {
            return;
