...
!(function (a) {
  a.extend(a.summernote.lang, {
    "pl-PL": {
      ...
      lists: { unordered: "Lista wypunktowana", ordered: "Lista numerowana" },
      options: { help: "Pomoc", fullscreen: "Pełny ekran", codeview: "Źródło" },
      paragraph: {
        paragraph: "Akapit",
      ...
      history: { undo: "Cofnij", redo: "Ponów" },
    },
  });
})(jQuery);
