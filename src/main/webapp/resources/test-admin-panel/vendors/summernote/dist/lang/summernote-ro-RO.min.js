...
!(function (a) {
  a.extend(a.summernote.lang, {
    "ro-RO": {
      ...
      table: { table: "Tabel" },
      hr: { insert: "Inserează o linie orizontală" },
      style: {
        style: "Stil",
        p: "p",
        blockquote: "Citat",
      ...
      lists: { unordered: "Listă neordonată", ordered: "Listă ordonată" },
      options: { help: "Ajutor", fullscreen: "Măreşte", codeview: "Sursă" },
      paragraph: {
        paragraph: "Paragraf",
      ...
      history: { undo: "Starea anterioară", redo: "Starea ulterioară" },
    },
  });
})(jQuery);
