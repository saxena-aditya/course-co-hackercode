              ...
              start: [
                {
                  ...
                  onMatch: function (e, t, n) {
                    return n.length && n[0].expectIf
                      ? ((n[0].expectIf = !1), (n[0].elseBranch = n[0]), [n[0]])
                      : ":";
                  },
                },
                {
      ...
      var r = e("./keyboard/hash_handler").HashHandler,
        ...
        l = function () {
          (this.autoInsert = !1),
            ...
            (this.tooltipTimer = u.delayedCall(
          ...
          (this.filterCompletions = function (e, t) {
            ...
            e: for (var s = 0, o; (o = e[s]); s++) {
              ...
              if (this.exactMatch) {
                ...
                var p;
                if ((p = u.toLowerCase().indexOf(i)) > -1)
                  for (var d = p; d < p + i.length; d++) f |= 1 << d;
                else
                  for (var v = 0; v < t.length; v++) {
                    var m = u.indexOf(i[v], a + 1),
                      g = u.indexOf(r[v], a + 1);
                    c = m >= 0 ? (g < 0 || m < g ? m : g) : g;
                    if (c < 0) continue e;
                    (h = c - a - 1),
