define("ace/keyboard/vim", [
  ...
  function ft(e, t) {
    var n = nt.registerController.registers;
  ...
  function Wt(e, t, n) {
    ...
    var n = n || r.visualLine ? "line" : r.visualBlock ? "block" : "char",
      i = Xt(e, t, n);
    e.setSelections(i.ranges, i.primary), Yn(e);
  }
  function Xt(e, t, n, r) {
    var i = Lt(t.head),
      s = Lt(t.anchor);
  ...
  function Zt(e, t) {
    (nt.lastCharacterSearch.increment = e),
      (nt.lastCharacterSearch.forward = t.forward),
      (nt.lastCharacterSearch.selectedCharacter = t.selectedCharacter);
  }
  function nn(e, t, n, r) {
  ...
  function Mn(e, t, n, r) {
    ...
    var i = dn(e),
      s = Nn(t, !!n, !!r);
    if (!s) return;
    return Dn(e, s), On(s, i.getQuery()) ? s : (i.setQuery(s), s);
  }
  function _n(e) {
  ...
  function zn(e) {
    ...
    if (!i) {
      var u =
          s.inVisualBlock && t.lastSelection
            ? t.lastSelection.visualBlock.height
            : 1,
        a = s.changes,
        o = [],
        f = 0;
      while (f < a.length) o.push(a[f]), a[f] instanceof er ? f++ : (f += u);
      (s.changes = o),
        e.off("change", Qn),
        v.off(e.getInputField(), "keydown", tr);
    }
    !i &&
      t.insertModeRepeat > 1 &&
      (nr(e, t, t.insertModeRepeat - 1, !0),
  ...
  function Vn(e, t, n, r) {
    ...
    if (r == ":") {
      i.keyBuffer[0] && Rn.processCommand(e, i.keyBuffer[0]),
        (n.isPlaying = !1);
      return;
    }
    var s = i.keyBuffer,
  ...
  function nr(e, t, n, r) {
    ...
    (t.inputState = o), t.insertMode && !r && zn(e), (i.isPlaying = !1);
  }
  function rr(e, t, n) {
    function r(t) {
    ...
    for (var f = 0; f < n; f++) {
      ...
      for (var l = 0; l < t.length; l++) {
        var c = t[l];
        if (c instanceof er) v.lookupKey(c.keyName, "vim-insert", r);
  ...
  function ur(e) {
    ...
    return (
      Object.keys(e).forEach(function (n) {
        ...
        Array.isArray(r)
          ? (r = r.slice())
          : r && typeof r == "object" && r.constructor != Object && (r = ur(r)),
          (t[n] = r);
      }),
      e.sel &&
        (t.sel = {
      ...
      e.operation(function () {
        e.ace.forEachSelection(function () {
          ...
          (s = St(s, 0, a)),
            ...
            e.virtualSelectionMode() && (e.state.vim = ur(o));
        }),
  ...
  (v.Pos = function (e, t) {
    ...
    (v.lookupKey = function hr(e, t, n) {
      ...
      if (t.fallthrough) {
        if (!Array.isArray(t.fallthrough)) return hr(e, t.fallthrough, n);
        for (var i = 0; i < t.fallthrough.length; i++) {
          var s = hr(e, t.fallthrough[i], n);
          if (s) return s;
        }
      }
    }),
  ...
  var L = { Shift: "S", Ctrl: "C", Alt: "A", Cmd: "D", Mod: "A" },
    A = { Enter: "CR", Backspace: "BS", Delete: "Del", Insert: "Ins" },
    _ = /[\d]/,
    D = [
      v.isWordChar,
      function (e) {
  ...
  var nt,
    ...
    st = {
      ...
      defineEx: function (e, t, n) {
        ...
        (qn[e] = n),
          (Rn.commandMap_[t] = { name: e, shortName: t, type: "api" });
      },
      ...
      findKey: function (e, t, n) {
        ...
        function s() {
          if (t == "<Esc>")
            return ut(e), r.visualMode ? $t(e) : r.insertMode && zn(e), !0;
        }
        function o(n) {
          var r;
          while (n)
  ...
  var ht = {
      ...
      processSearch: function (e, t, n) {
        ...
        function l(t, n, i) {
          ...
          f
            ? e.scrollIntoView(Pn(e, !r, f), 30)
            : (Hn(e), e.scrollTo(u.left, u.top));
        }
        function c(t, n, r) {
          var i = v.keyName(t);
          i == "Esc" ||
    ...
    pt = {
      ...
      findNext: function (e, t, n) {
        ...
        if (!i) return;
        var s = !n.forward;
        return (s = r.isReversed() ? !s : s), Dn(e, i), Pn(e, s, i, n.repeat);
      },
      goToMark: function (e, t, n, r) {
        var i = Fn(e, r, n.selectedCharacter);
        return i
          ? n.linewise
            ? { line: i.line, ch: Qt(e.getLine(i.line)) }
            : i
          : null;
      },
      ...
      moveByLines: function (e, t, n, r) {
        ...
        if (u > f && i.line == f) return this.moveToEol(e, t, n, r);
    ...
    yt = {
      ...
      enterMacroRecordMode: function (e, t) {
        ...
        nt.registerController.isValidRegister(r) &&
      ...
      enterInsertMode: function (e, t, n) {
        ...
        e.setOption("disableInput", !1),
          ...
          nt.macroModeState.isPlaying ||
            (e.on("change", Qn), v.on(e.getInputField(), "keydown", tr)),
          n.visualMode && $t(e),
          It(e, s, o);
      },
      ...
      incrementNumberToken: function (e, t) {
        ...
        var v = E(n.line, o),
          m = E(n.line, u);
        e.replaceRange(a, v, m), e.setCursor(E(n.line, o + a.length - 1));
      },
  ...
  In.prototype = {
    ...
    _processCommand: function (e, t, n) {
      ...
      if (!l) {
        Cn(e, 'Not an editor command ":' + t + '"');
        return;
      }
      try {
        qn[l](e, u), (!f || !f.possiblyAsync) && u.callback && u.callback();
      } catch (a) {
        throw (Cn(e, a), a);
      }
    },
  ...
  var qn = {
      ...
      global: function (e, t) {
        ...
        var d = 0,
          v = function () {
            if (d < l.length) {
              var t = l[d] + u;
              Rn.processCommand(e, t, { callback: v });
            }
            d++;
          };
        v();
      ...
      yank: function (e) {
        var t = Lt(e.getCursor()),
          n = t.line,
          r = e.getLine(n);
        nt.registerController.pushText("0", "yank", r, !0, !0);
      },
    ...
    (yt.aceCommand = function (e, t, n) {
      (e.vimCmd = t),
        e.ace.inVirtualSelectionMode
          ? e.ace.on("beforeEndOperation", cr)
          : cr(null, e.ace);
    }),
