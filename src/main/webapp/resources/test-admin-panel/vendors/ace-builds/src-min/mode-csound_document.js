    ...
    function (e, t, n) {
      ...
      var r = e("../lib/lang"),
        ...
        f = function () {
          ...
          n.splice(1, 0, {
            ...
            n.push(
              ...
              { token: "support.variable.csound", regex: /\bp\d+\b/ },
              {
                ...
                onMatch: function (n, r, i, s) {
                  var o = n.split(this.splitRegex),
                    u = o[1],
                    a;
                  return (
                    e.hasOwnProperty(u)
          ...
          this.embedRules(o, "csound-score-", i),
            this.embedRules(a, "python-", i),
            this.embedRules(u, "lua-", i),
            this.normalizeRules();
        };
      ...
      var r = e("../lib/oop"),
        ...
        a = function () {
          (this.$rules = {
            ...
            this.embedRules(s, "csound-score-", [
              {
                token: [
                  "meta.tag.punctuation.end-tag-open.csound-document",
                  "entity.name.tag.begin.csound-document",
