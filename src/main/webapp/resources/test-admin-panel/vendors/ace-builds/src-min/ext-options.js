define(
  ...
  define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("./menu_tools/overlay_page").overlayPage,
        i = e("../lib/dom"),
        s = e("../lib/oop"),
      ...
      var c = a.modes.map(function (e) {
        ...
        h = {
          Main: {
            ...
            "Soft Tabs": [
              { path: "useSoftTabs" },
              { path: "tabSize", type: "number", values: [2, 3, 4, 8, 16] },
            ],
            Overscroll: {
              type: "buttonBar",
              path: "scrollPastEnd",
          ...
          More: {
            ...
            "Show Print Margin": [
              ...
              { type: "number", path: "printMarginColumn" },
            ],
      ...
      (function () {
        s.implement(this, o),
          (this.add = function (e) {
            e.Main && s.mixin(h.Main, e.Main),
              e.More && s.mixin(h.More, e.More);
          }),
          ...
          (this.setOption = function (e, t) {
            typeof e == "string" && (e = this.options[e]),
              ...
              typeof t == "string" &&
                ...
                (t = parseFloat(t)),
              e.onchange ? e.onchange(t) : this.editor.setOption(e.path, t),
