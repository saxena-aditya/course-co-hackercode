      ...
      var r = e("../lib/event"),
        ...
        c = function (e, t) {
          ...
          (c.className = i.isIOS
            ...
            : "ace_text-input"),
            i.isTouchPad && c.setAttribute("x-palm-disable-auto-cap", !0),
                    ...
                    : p ||
                      (e.substring(0, 9) == h && e.length > h.length
                        ...
                        : e.substr(0, 4) == h.substr(0, 4)
                          ? (e = e.substr(4, e.length - h.length + 1))
            ...
            F = function (e) {
              ...
              (k = function (i) {
                return (
                  r && clearTimeout(r),
                  (i = i.replace(/\x01/g, "")),
                  i == n.lastValue ? "" : (n.lastValue && r && t.undo(), i)
                );
              }),
                t.onCompositionEnd(),
              ...
              var o = t.container.getBoundingClientRect(),
                ...
                h = function (e) {
                  (c.style.left = e.clientX - f - 2 + "px"),
                    (c.style.top = Math.min(e.clientY - a - 2, l) + "px");
                };
              h(e);
      ...
      var r = e("../lib/event"),
        ...
        c = function (e, t) {
                  ...
                  : e == c.charAt(0)
                    ...
                    : (e.substring(0, 2) == c
                        ...
                        : e.charAt(0) == c.charAt(0)
                          ? (e = e.substr(1))
                          : e.charAt(e.length - 1) == c.charAt(0) &&
                            (e = e.slice(0, -1)),
                      e.charAt(e.length - 1) == c.charAt(0) &&
                        (e = e.slice(0, -1)),
                      e && t.onTextInput(e)),
          ...
          r.addCommandKeyListener(n, t.onCommandKey.bind(t)),
            r.addListener(n, "select", k),
            r.addListener(n, "input", M),
            r.addListener(n, "cut", P),
            r.addListener(n, "copy", H),
            r.addListener(n, "paste", B),
          ...
          var j = function (e) {
              ...
              (v = {}),
                (v.canUndo = t.session.$undoManager),
                t.onCompositionStart(),
                setTimeout(F, 0),
                t.on("mousedown", I),
                v.canUndo &&
            ...
            F = function () {
              ...
              t.onCompositionUpdate(e),
                v.lastValue && t.undo(),
                v.canUndo && (v.lastValue = e);
              if (v.lastValue) {
                var r = t.selection.getRange();
                t.insert(v.lastValue),
                  t.session.markUndoGroup(),
                  (v.range = t.selection.getRange()),
            ...
            I = function (e) {
              ...
              (L = function (n) {
                return (
                  s && clearTimeout(s),
                  (n = n.replace(h, "")),
                  n == r.lastValue ? "" : (r.lastValue && s && t.undo(), n)
                );
              }),
                t.onCompositionEnd(),
                t.removeListener("mousedown", I),
                e.type == "compositionend" &&
                  r.range &&
          ...
          r.addListener(n, "compositionstart", j),
            r.addListener(n, "compositionupdate", function () {
              q.schedule();
            }),
            ...
            r.addListener(n, "compositionend", I),
            (this.getElement = function () {
              return n;
            }),
            ...
            (this.moveToMouse = function (e, o) {
              ...
              t.renderer.$keepTextAreaAtCursor &&
                (t.renderer.$keepTextAreaAtCursor = null),
                clearTimeout(R),
                i.isWin && r.capture(t.container, h, U);
            }),
          ...
          r.addListener(n, "mouseup", z),
            r.addListener(n, "mousedown", function (e) {
              e.preventDefault(), U();
            }),
            r.addListener(t.renderer.scroller, "contextmenu", z),
            r.addListener(n, "contextmenu", z);
        };
      t.TextInput = c;
    },
  ),
        ...
        (this.onMouseDown = function (e) {
          ...
          if (i !== 0) {
            var o = r.getSelectionRange(),
              u = o.isEmpty();
            (u || i == 1) && r.selection.moveToPosition(n),
              i == 2 &&
          ...
          (this.focusWait = function () {
            var e = f(
              ...
              t = Date.now();
            (e > o || t - this.mousedownEvent.time > this.$focusTimeout) &&
          ...
          (this.onMouseWheel = function (e) {
            ...
            if (f) n.allowed = r;
              ...
              var l =
                Math.abs(s) <= 1.1 * Math.abs(n.vx) &&
                Math.abs(o) <= 1.1 * Math.abs(n.vy);
              ...
              f = function (e) {
                n.off("beforeEndOperation", c),
                  ...
                  s.$keepTextAreaAtCursor == null &&
                    ((s.$keepTextAreaAtCursor = !0), s.$moveTextAreaToCursor()),
                  (o.isMousePressed = !1),
      ...
      function i(e) {
        e.on("click", function (t) {
          ...
          o &&
            ...
            (i.setOption("wrap", !0), e.renderer.scrollCursorIntoView());
        }),
      ...
      (t.L = g),
        ...
        (t.hasBidiCharacters = function (e, t) {
          ...
          for (var r = 0; r < e.length; r++)
            (t[r] = R(e.charAt(r))), !n && (t[r] == y || t[r] == T) && (n = !0);
          return n;
        }),
        ...
        (this.isBidiRow = function (e, t, n) {
          ...
          (this.updateRowLine = function (e, t) {
              ...
              n &&
                ...
                t > 0 && n.length
                  ? ((this.wrapIndent = n.indent),
                    (this.line =
                      t < n.length
                        ? this.line.substring(n[t - 1], n[n.length - 1])
                        : this.line.substring(n[n.length - 1])))
            ...
            this.line = this.line.replace(
              /\t|[\u1100-\u2029, \u202F-\uFFE6]/g,
              function (e, t) {
                return e === "	" || s.isFullWidth(e.charCodeAt(0))
                  ? ((u = e === "	" ? s.getScreenTabSize(t + o) : 2),
                    (o += u - 1),
                    i.stringRepeat(r.DOT, u))
                  : e;
              },
            );
          }),
          (this.updateBidiMap = function () {
            ...
            r.hasBidiCharacters(n, e)
              ? (this.bidiMap = r.doBidiReorder(n, e, this.isRtlDir))
              : (this.bidiMap = {});
          }),
          ...
          (this.updateCharacterWidths = function (e) {
            ...
            (this.charWidths[r.L] =
              ...
              (this.charWidths[r.R_H] = s.isChrome ? n : n * 0.45),
          ...
          (this.getPosLeft = function (e) {
            ...
            return (
              e !== 0 && n[t] % 2 === 0 && (i += this.charWidths[n[t]]),
              this.wrapIndent && (i += this.wrapIndent * this.charWidths[r.L]),
              i
            );
          }),
          (this.getSelections = function (e, t) {
            var n = this.bidiMap,
              i = n.bidiLevels,
              s,
              o = this.wrapIndent * this.charWidths[r.L],
              u = [],
            ...
            for (var p, d = 0; d < i.length; d++)
              (p = n.logicalFromVisual[d]),
                (s = i[d]),
                (l = p >= a && p < f),
                l && !c
                  ? (h = o)
                  : !l && c && u.push({ left: h, width: o - h }),
                (o += this.charWidths[s]),
                (c = l);
            return l && d === i.length && u.push({ left: h, width: o - h }), u;
          }),
          (this.offsetToCol = function (e) {
            ...
            return (
              i > 0 && s[i - 1] % 2 !== 0 && s[i] % 2 === 0
                ? (e < n && i--, (t = this.bidiMap.logicalFromVisual[i]))
                : i > 0 && s[i - 1] % 2 === 0 && s[i] % 2 !== 0
                  ? (t =
                      1 +
                      (e > n
                        ? this.bidiMap.logicalFromVisual[i]
                        : this.bidiMap.logicalFromVisual[i - 1]))
                  : (this.isRtlDir &&
                        i === s.length - 1 &&
                        o === 0 &&
                        s[i - 1] % 2 === 0) ||
                      (!this.isRtlDir && i === 0 && s[i] % 2 !== 0)
                    ? (t = 1 + this.bidiMap.logicalFromVisual[i])
                    : (i > 0 && s[i - 1] % 2 !== 0 && o !== 0 && i--,
                      (t = this.bidiMap.logicalFromVisual[i])),
              t + this.wrapIndent
            );
          });
      }).call(u.prototype),
    ...
    function (e, t, n) {
      ...
      (function () {
        (this.$defaultBehaviour = new s()),
          (this.tokenRe = new RegExp("^[" + o.wordChars + "\\$_]+", "g")),
            ...
            for (; l <= f; l++)
              (v.start.row = v.end.row = l),
                ...
                this.session.$bidiHandler.isBidiRow(l)
                  ? this.drawBidiSingleLineMarker(t, v, d, s, l == f ? 0 : 1, o)
                  : this.drawSingleLineMarker(t, v, d, s, l == f ? 0 : 1, o);
          }),
          ...
          (this.renderIndentGuide = function (e, t, n) {
            ...
            return r <= 0 || r >= n
              ...
              : t[0] == " "
                ? ((r -= r % this.tabSize),
                  e.push(
                    s.stringRepeat(this.$tabStrings[" "], r / this.tabSize),
                  ),
                  t.substr(r))
                : t[0] == "	"
                  ? (e.push(s.stringRepeat(this.$tabStrings["	"], r)),
                    t.substr(r))
                  : t;
          }),
        ...
        this.schedule = function (e) {
          ...
          if (this.changes) {
            ...
            r.nextFrame(function (e) {
              var n = t.changes;
              n && (r.blockIdle(100), (t.changes = 0), t.onRender(n)),
                t.changes && t.schedule();
            });
          }
        };
      }).call(i.prototype),
      ...
      (function () {
        (this.CHANGE_CURSOR = 1),
          ...
          (this.$moveTextAreaToCursor = function () {
            ...
            (r -= this.scrollLeft),
              r > this.$size.scrollerWidth - s &&
                (r = this.$size.scrollerWidth - s),
              (r += this.gutterWidth),
              (e.height = i + "px"),
              (e.width = s + "px"),
              (e.left = Math.min(r, this.$size.scrollerWidth - s) + "px"),
              (e.top = Math.min(n, this.$size.height - i) + "px");
          }),
          (this.getFirstVisibleRow = function () {
