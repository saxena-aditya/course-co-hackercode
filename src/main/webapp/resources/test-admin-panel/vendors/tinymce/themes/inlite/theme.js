...
jsc*/
  ...
  define("tinymce.core.ThemeManager", [
  ...
  define("tinymce.themes.inlite.alien.Arr", [], function () {
  ...
  define("tinymce.themes.inlite.alien.Type", [], function () {
  ...
  define("tinymce.themes.inlite.core.Matcher", [], function () {
  ...
  define("tinymce.themes.inlite.core.Convert", [], function () {
   ...
   */
  define("tinymce.themes.inlite.alien.Uuid", [], function () {
    var count = 0;
  ...
  define("tinymce.themes.inlite.alien.Bookmark", [], function () {
    /**
  ...
  define("tinymce.themes.inlite.core.UrlType", [], function () {
  ...
  define("tinymce.themes.inlite.ui.Panel", [
    ...
    return function () {
      ...
      var repositionPanelAt = function (panel, id, editor, targetRect) {
        ...
        userConstainHandler = EditorSettings.getHandlerOr(
          editor,
