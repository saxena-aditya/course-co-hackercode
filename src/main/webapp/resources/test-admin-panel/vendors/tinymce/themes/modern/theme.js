...
jsc*/
  ...
  define("tinymce.themes.modern.ui.A11y", [], function () {
  ...
  define("tinymce.themes.modern.ui.Branding", [
    ...
    var reposition = function (editor, poweredByElm, hasStatusbar) {
      return function () {
        var iframeWidth = editor
          .getContentAreaContainer()
          .querySelector("iframe").offsetWidth;
        var scrollbarWidth = Math.max(
          iframeWidth - editor.getDoc().documentElement.offsetWidth,
          0,
        );
    ...
    var setupEventListeners = function (editor) {
      editor.on("SkinLoaded", function () {
        var poweredByElm = DOM.create("div", {
          class: "mce-branding-powered-by",
        });
        var statusbarElm = editor
          .getContainer()
          .querySelector(".mce-statusbar");
  ...
  define("tinymce.themes.modern.ui.Toolbar", [
  ...
  define("tinymce.themes.modern.ui.SkinLoaded", [], function () {
  ...
  define("tinymce.core.ui.FloatPanel", [
    "global!tinymce.util.Tools.resolve",
  ], function (resolve) {
  ...
  define("tinymce.themes.modern.modes.Inline", [
    "tinymce.core.util.Tools",
    "tinymce.core.ui.Factory",
    "tinymce.core.dom.DOMUtils",
