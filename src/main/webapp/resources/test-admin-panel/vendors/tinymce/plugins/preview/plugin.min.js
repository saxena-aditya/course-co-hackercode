            ...
            a.windowManager.open({
              ...
              onPostRender: function () {
                var b,
                  f = "",
                  g = a.dom.encode;
                (f += '<base href="' + g(a.documentBaseURI.getURI()) + '">'),
                  c.each(a.contentCSS, function (b) {
                    f +=
                      '<link type="text/css" rel="stylesheet" href="' +
                      g(a.documentBaseURI.toAbsolute(b)) +
                      '">';
                  });
                var h = d.body_id || "tinymce";
                h.indexOf("=") != -1 &&
                  ((h = a.getParam("body_id", "", "hash")), (h = h[a.id] || h));
                var i = d.body_class || "";
                i.indexOf("=") != -1 &&
                  ((i = a.getParam("body_class", "", "hash")),
                  (i = i[a.id] || ""));
                var j =
                  ...
                  k = a.settings.directionality
                    ? ' dir="' + a.settings.directionality + '"'
                    : "";
                if (
                  ((b =
                  ...
                  var l = this.getEl("body").firstChild.contentWindow.document;
                  l.open(), l.write(b), l.close();
                }
              },
            });
          }),
            a.addButton("preview", { title: "Preview", cmd: "mcePreview" }),
