!(function () {
  ...
  h("5", tinymce.util.Tools.resolve),
    ...
    g("0", ["1", "2", "3", "4"], function (a, b, c, d) {
      return (
        a.add("save", function (a) {
          function e() {
            var d;
            if (
              ((d = b.DOM.getParent(a.id, "form")),
              !a.getParam("save_enablewhendirty", !0) || a.isDirty())
            )
              return (
                c.triggerSave(),
                a.getParam("save_onsavecallback")
                  ? (a.execCallback("save_onsavecallback", a),
                    void a.nodeChanged())
                  : void (d
                      ? (a.setDirty(!1),
                        (d.onsubmit && !d.onsubmit()) ||
                          ("function" == typeof d.submit
                            ? d.submit()
                            : f(
                                a.translate(
                        ...
                        a.nodeChanged())
                      : f(a.translate("Error: No form element found.")))
              );
          }
          function f(b) {
          ...
          a.addCommand("mceSave", e),
            a.addCommand("mceCancel", g),
            a.addButton("save", {
              icon: "save",
              text: "Save",
              cmd: "mceSave",
