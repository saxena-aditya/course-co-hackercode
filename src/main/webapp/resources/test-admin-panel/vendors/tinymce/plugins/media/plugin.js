...
jsc*/
  ...
  define("tinymce.core.html.Writer", [
    "global!tinymce.util.Tools.resolve",
  ], function (resolve) {
  ...
  define("tinymce.plugins.media.core.VideoScript", [], function () {
  ...
  define("tinymce.plugins.media.core.Size", [], function () {
  ...
  define("tinymce.plugins.media.core.Mime", [], function () {
  ...
  define("tinymce.plugins.media.core.UrlPatterns", [], function () {
    var urlPatterns = [
      {
        regex: /youtu\.be\/([\w\-.]+)/,
        type: "iframe",
  ...
  define("tinymce.plugins.media.core.DataToHtml", [
    ...
    var dataToHtml = function (editor, dataIn) {
      ...
      if (!data.source1) {
        Tools.extend(
          data,
          HtmlToData.htmlToData(editor.settings.media_scripts, data.embed),
        );
        if (!data.source1) {
          return "";
        }
  ...
  define("tinymce.plugins.media.ui.SizeManager", [], function () {
  ...
  define("tinymce.plugins.media.ui.Dialog", [
    ...
    var addEmbedHtml = function (win, editor) {
      return function (response) {
        ...
        var data = Tools.extend(
          HtmlToData.htmlToData(editor.settings.media_scripts, html),
    ...
    var showDialog = function (editor) {
      ...
      var updateValueOnChange = function () {
        data = Tools.extend(
          {},
          HtmlToData.htmlToData(editor.settings.media_scripts, this.value()),
        );
