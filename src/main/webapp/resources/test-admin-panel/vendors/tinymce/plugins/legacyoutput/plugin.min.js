!(function () {
  ...
  h("3", tinymce.util.Tools.resolve),
    ...
    g("0", ["1", "2"], function (a, b) {
      return (
        a.add("legacyoutput", function (a, c, d) {
          (a.settings.inline_styles = !1),
            a.on("init", function () {
              var c = "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img",
                d = b.explode(a.settings.font_size_style_values),
                e = a.schema;
              a.formatter.register({
                ...
                b.each("b,i,u,strike".split(","), function (a) {
                  e.addValidElements(a + "[*]");
                }),
                e.getElementRule("font") ||
                  e.addValidElements("font[face|size|color|style]"),
                b.each(c.split(","), function (a) {
                  var b = e.getElementRule(a);
                  b &&
                    (b.attributes.align ||
                      ((b.attributes.align = {}),
                      b.attributesOrder.push("align")));
                });
            }),
            a.addButton("fontsizeselect", function () {
              var b = [],
                c = "8pt=1 10pt=2 12pt=3 14pt=4 18pt=5 24pt=6 36pt=7",
                d = a.settings.fontsizeFormats || c;
              return (
                ...
                }),
                {
                  ...
                  onPostRender: function () {
                    ...
                    a.on("NodeChange", function () {
                      var c;
                      (c = a.dom.getParent(a.selection.getNode(), "font")),
                        c ? b.value(c.size) : b.value("");
                    });
                  },
                  onclick: function (b) {
              ...
              return (
                d.each(f, function (a, b) {
                  e.push({
                    ...
                    value: b[1],
                    textStyle:
                      b[1].indexOf("dings") == -1 ? "font-family:" + b[1] : "",
                  });
                }),
                {
                  type: "listbox",
