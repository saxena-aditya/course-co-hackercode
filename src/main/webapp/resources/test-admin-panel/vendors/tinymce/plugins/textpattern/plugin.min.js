  ...
  h("7", tinymce.util.Tools.resolve),
      ...
      var a = function (a) {
        ...
        b = function (a, b) {
          for (var c = 0; c < a.length; c++)
            if (
              0 === b.indexOf(a[c].start) &&
              (!a[c].end ||
                b.lastIndexOf(a[c].end) === b.length - a[c].end.length)
            )
              return a[c];
        },
        c = function (a, b, c, d) {
          var e = b.substr(c - a.end.length - d, a.end.length);
          return e === a.end;
        },
        d = function (a, b, c) {
        ...
        e = function (b, e, f, g) {
          ...
          for (i = 0; i < j.length; i++)
            if (((h = j[i]), void 0 !== h.end && c(h, e, f, g) && d(f, g, h)))
              return h;
        };
    ...
    g("4", ["8", "9", "a"], function (a, b, c) {
      var d = function (a, b, c, d, e) {
          return (
            (a = d > 0 ? a.splitText(d) : a),
            a.splitText(c - d - e),
            a.deleteData(0, b.start.length),
            a.deleteData(a.data.length - b.end.length, b.end.length),
            a
          );
        },
        e = function (a, b, e) {
          ...
          if (
            ...
            f.isCollapsed() &&
              ...
              (o = e === !0 ? 1 : 0),
              3 == i.nodeType &&
                ((n = c.findEndPattern(b, l, j, o)),
                void 0 !== n &&
                  ((k = Math.max(0, j - o)),
                  (k = l.lastIndexOf(n.start, k - n.end.length - 1)),
                  k !== -1 &&
                    ((m = g.createRng()),
                    m.setStart(i, k),
                    m.setEnd(i, j - o),
                    (n = c.findPattern(b, m.toString())),
                    n &&
                      n.end &&
                      !(i.data.length <= n.start.length + n.end.length))))))
          )
            return (
              (p = a.formatter.get(n.format)),
              p && p[0].inline
        ...
        f = function (d, e) {
          ...
          if (
            ((f = d.selection),
            (g = d.dom),
            f.isCollapsed() && (l = g.getParent(f.getStart(), "p")))
          ) {
            ...
            if (i) {
              if (((m = c.findPattern(e, i.data)), !m)) return;
              if (
                ((o = f.getRng(!0)),
                (h = o.startContainer),
                (p = o.startOffset),
                i == h && (p = Math.max(0, p - m.start.length)),
                b.trim(i.data).length == m.start.length)
              )
                return;
              m.format &&
                ((k = d.formatter.get(m.format)),
                k &&
                  k[0].block &&
                  (i.deleteData(0, m.start.length),
                  d.formatter.apply(m.format, {}, i),
                  o.setStart(h, p),
                  o.collapse(!0),
                  f.setRng(o))),
                m.cmd &&
    ...
    g("5", ["3", "4"], function (a, b) {
      function c(a, c) {
        var d, e;
        (e = b.applyInlineFormat(a, c, !1)),
          e &&
            ((d = a.dom.createRng()),
            d.setStart(e, e.data.length),
            d.setEnd(e, e.data.length),
            a.selection.setRng(d)),
          b.applyBlockFormat(a, c);
      }
      function d(a, c) {
        var d, e, f, g, h;
        (d = b.applyInlineFormat(a, c, !0)),
          d &&
            ((h = a.dom),
            (e = d.data.slice(-1)),
            /[\u00a0 ]/.test(e) &&
              (d.deleteData(d.data.length - 1, 1),
              (f = h.doc.createTextNode(e)),
              d.nextSibling
                ? h.insertAfter(f, d.nextSibling)
      ...
      var e = function (a, b, c) {
          for (var d = 0; d < a.length; d++) if (c(a[d], b)) return !0;
        },
        f = function (b, c) {
    ...
    g("6", [], function () {
      var a = [
        ...
        b = function (b) {
          return void 0 !== b.textpattern_patterns ? b.textpattern_patterns : a;
        };
      return { getPatterns: b };
    }),
    g("0", ["1", "2", "3", "4", "5", "6"], function (a, b, c, d, e, f) {
      return (
        a.add("textpattern", function (a) {
