!(function () {
  ...
  h("3", tinymce.util.Tools.resolve),
    ...
    g("0", ["1", "2"], function (a, b) {
      return (
        a.add("insertdatetime", function (a) {
          function c(b, c) {
            function d(a, b) {
              if (((a = "" + a), a.length < b))
            ...
            return (
              ...
              (b = b.replace("%B", "" + a.translate(j[c.getMonth()]))),
              (b = b.replace("%b", "" + a.translate(i[c.getMonth()]))),
              (b = b.replace("%A", "" + a.translate(h[c.getDay()]))),
          ...
          function d(b) {
            ...
            if (a.settings.insertdatetime_element) {
              var e;
              (e = c(/%[HMSIp]/.test(b) ? "%Y-%m-%dT%H:%M" : "%Y-%m-%d")),
          ...
          var e,
            f,
            g = "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "),
            h =
          ...
          a.addCommand("mceInsertDate", function () {
            d(a.getParam("insertdatetime_dateformat", a.translate("%Y-%m-%d")));
          }),
            ...
            b.each(
              a.settings.insertdatetime_formats || [
                "%H:%M:%S",
                "%Y-%m-%d",
                "%I:%M:%S %p",
                "%D",
