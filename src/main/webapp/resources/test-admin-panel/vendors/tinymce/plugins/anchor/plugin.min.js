        ...
        b.add("anchor", function (b) {
            ...
            d = function (a) {
              return function (b) {
                for (var d = 0; d < b.length; d++)
                  c(b[d]) && b[d].attr("contenteditable", a);
              };
            },
            e = function (a) {
              return /^[A-Za-z][A-Za-z0-9\-:._]*$/.test(a);
            },
            f = function () {
              var a = b.selection.getNode(),
                c = "A" == a.tagName && "" === b.dom.getAttrib(a, "href"),
                d = "";
              c && (d = a.id || a.name || ""),
                b.windowManager.open({
                  ...
                  onsubmit: function (d) {
                    ...
                    return e(f)
                      ? void (c
                          ? (a.removeAttribute("name"), (a.id = f))
                          : (b.selection.collapse(!0),
                            b.execCommand(
                              "mceInsertContent",
                              !1,
                              b.dom.createHTML("a", { id: f }),
                            )))
                      : (d.preventDefault(),
                        void b.windowManager.alert(
          ...
          a.ceFalse &&
            b.on("PreInit", function () {
              b.parser.addNodeFilter("a", d("false")),
                b.serializer.addNodeFilter("a", d(null));
            }),
            b.addCommand("mceAnchor", f),
            b.addButton("anchor", {
              icon: "anchor",
              tooltip: "Anchor",
              onclick: f,
