!(function () {
  ...
  h("b", tinymce.util.Tools.resolve),
    g("1", ["b"], function (a) {
    ...
    g("c", ["2"], function (a) {
      function b(b) {
        (!a.ie || a.ie > 9) &&
          (b.hasChildNodes() || (b.innerHTML = '<br data-mce-bogus="1" />'));
      }
      var c = function (a) {
          return function (b, c) {
            b &&
              ((c = parseInt(c, 10)),
              1 === c || 0 === c
                ? b.removeAttribute(a, 1)
                : b.setAttribute(a, c, 1));
          };
        },
        d = function (a) {
          return function (b) {
      ...
      return {
        ...
        setSpanVal: function (a, b, d) {
          c(b)(a, d);
        },
        getSpanVal: function (a, b) {
          return d(b)(a);
        },
        paddCell: b,
      };
    }),
    g("d", ["4", "c"], function (a, b) {
      var c = function (a, b, c) {
          return a[c] ? a[c][b] : null;
        },
        d = function (a, b, d) {
          var e = c(a, b, d);
          return e ? e.elm : null;
        ...
        e = function (a, b, e, f) {
          ...
          for (
            g = e;
            (f > 0 ? g < a.length : g >= 0) && ((h = c(a, b, g)), j === h.elm);
            g += f
          )
            i++;
          return i;
        ...
        h = function (a, c) {
          ...
          return (
            b.setColSpan(e, b.getColSpan(a.elm)),
            b.setRowSpan(e, c),
            b.paddCell(e),
            e
          );
        ...
        i = function (a, b, c, d) {
          ...
          e
            ...
            : ((e = f(a, 0, d)), e.parentNode.appendChild(b));
        },
        j = function (a, c, d, e) {
          if (0 !== c.above) {
    ...
    g("6", ["4", "2", "c", "d"], function (a, b, c, d) {
      var e = a.each,
        f = c.getSpanVal,
        g = c.setSpanVal;
      return function (h, i, j) {
        function k() {
          h.$("td[data-mce-selected],th[data-mce-selected]").removeAttr(
            "data-mce-selected",
          );
        }
        function l(a) {
        ...
        function n() {
          ...
          (Z = []),
            ...
            e(["thead", "tbody", "tfoot"], function (b) {
              ...
              e(d, function (c, d) {
                (d += a),
                  e(m(c, "td,th"), function (a, c) {
                    var e, g, h, i;
                    if (Z[d]) for (; Z[d][c]; ) c++;
                    for (
                      h = f(a, "rowspan"), i = f(a, "colspan"), g = d;
                      g < d + h;
                      g++
                    )
        ...
        function o(a) {
          return h.fire("newrow", { node: a }), a;
        }
        function p(a) {
          return h.fire("newcell", { node: a }), a;
        }
        function q(a, b) {
        ...
        function t(a, b) {
          for (var c = [], d = 0; d < a.length; d++) c.push(r(b, d));
          return c;
        }
        function u(a) {
          ...
          return (
            e(i.rows, function (b) {
              e(b.cells, function (c) {
                if (ca.getAttrib(c, "data-mce-selected") || (j && c == j.elm))
                  return a.push(b), !1;
              });
            }),
            a
        ...
        function x() {
          var a = ca.createRng();
          l(i) ||
            (a.setStartAfter(i), a.setEndAfter(i), ba.setRng(a), ca.remove(i));
        }
        function y(d) {
          var f,
            i = {};
          return (
            h.settings.table_clone_elements !== !1 &&
              (i = a.makeMap(
                (
                  h.settings.table_clone_elements ||
            ...
            a.walk(
              ...
              function (a) {
                ...
                if (3 == a.nodeType)
                  return (
                    e(
                      ca.getParents(a.parentNode, null, d).reverse(),
                      function (a) {
                        i[a.nodeName] &&
                          ((a = q(a, !1)),
                          f ? c && c.appendChild(a) : (f = c = a),
                          (c = a));
                      },
                    ),
                    c &&
            ...
            g(d, "rowSpan", 1),
            g(d, "colSpan", 1),
            f ? d.appendChild(f) : c.paddCell(d),
            d
          );
        }
        function z() {
          var a,
            b = ca.createRng();
          return (
            e(ca.select("tr", i), function (a) {
              0 === a.cells.length && ca.remove(a);
            }),
            0 === ca.select("tr", i).length
              ? (b.setStartBefore(i),
                b.setEndBefore(i),
                ba.setRng(b),
                void ca.remove(i))
              : (e(ca.select("thead,tbody,tfoot", i), function (a) {
                  0 === a.rows.length && ca.remove(a);
                }),
                n(),
                void (
                  _ &&
                  ((a = Z[Math.min(Z.length - 1, _.y)]),
                  a &&
                    (ba.select(a[Math.min(a.length - 1, _.x)].elm, !0),
                    ba.collapse(!0)))
                ))
          );
        }
            ...
            if ((e = ca.getNext(e, "tr"))) {
              for (f = a; f >= 0; f--)
                if (((i = Z[b + g][f].elm), i.parentNode == e)) {
                  for (h = 1; h <= d; h++) ca.insertAfter(y(i), i);
                  break;
                }
              if (f == -1)
                for (h = 1; h <= d; h++)
          ...
          e(Z, function (a, b) {
            e(a, function (a, c) {
              ...
              if (
                ...
                for (
                  g(a, "rowSpan", 1), g(a, "colSpan", 1), h = 0;
                  h < d - 1;
                  h++
                )
          ...
          if (
            (b
              ...
              : ((_ = aa = null),
                e(Z, function (a, b) {
                  e(a, function (a, c) {
                    u(a) && (_ || (_ = { x: c, y: b }), (aa = { x: c, y: b }));
                  });
                }),
                _ && ((h = _.x), (i = _.y), (j = aa.x), (k = aa.y))),
            (o = r(h, i)),
            (p = r(j, k)),
            o && p && o.part == p.part)
          ) {
            ...
            for (
              ...
              for (l = h; l <= j; l++)
                Z[m] &&
                  ...
                  ((b = Z[m][l].elm),
                  b != o &&
                    ((q = a.grep(b.childNodes)),
                    e(q, function (a) {
                      o.appendChild(a);
                    }),
                    q.length &&
                      ((q = a.grep(o.childNodes)),
                      (s = 0),
                      e(q, function (a) {
                        "BR" == a.nodeName &&
                          s++ < q.length - 1 &&
        ...
        function I(a) {
          ...
          if (
            ...
            for (h = 0, n = 0; h < Z[0].length; h += n)
              if (
                Z[b][h] &&
                ((c = Z[b][h].elm), (n = f(c, "colspan")), c != d)
              ) {
                if (a) {
                  if (
                    b > 0 &&
                    Z[b - 1][h] &&
                    ((l = Z[b - 1][h].elm), (m = f(l, "rowSpan")), m > 1)
                  ) {
                    g(l, "rowSpan", m + 1);
                    continue;
                  }
                ...
                (k = y(c)),
                  g(k, "colSpan", c.colSpan),
                  j.appendChild(k),
                  (d = c);
              }
            j.hasChildNodes() &&
              (a ? i.parentNode.insertBefore(j, i) : ca.insertAfter(j, i));
          }
        }
        function J(a, b) {
          b = b || v().length || 1;
          for (var c = 0; c < b; c++) I(a);
        }
        function K(a) {
          var b, c;
          e(Z, function (c) {
            ...
            e(Z, function (d, e) {
              ...
              d[b] &&
                ...
                h != c &&
                  ...
                  1 == j
                    ? a
                      ? (h.parentNode.insertBefore(y(h), h), A(b, e, i - 1, j))
                      : (ca.insertAfter(y(h), h), A(b, e, i - 1, j))
                    : g(h, "colSpan", h.colSpan + 1),
                  (c = h)));
            });
        }
        function L(a, b) {
          b = b || w() || 1;
          for (var c = 0; c < b; c++) K(a);
        }
        function M(b) {
          return a.grep(N(b), u);
        }
              ...
              u(c) &&
                ...
                (e(Z, function (a) {
                  var b,
                    c = a[d].elm;
                  (b = f(c, "colSpan")),
                    b > 1 ? g(c, "colSpan", b - 1) : ca.remove(c);
                }),
                b.push(d));
            });
          }),
            ...
            e(a.cells, function (a) {
              ...
              e(Z[b.y], function (a) {
                ...
                (a = a.elm),
                  a != c &&
                    ((b = f(a, "rowSpan")),
                    b <= 1 ? ca.remove(a) : g(a, "rowSpan", b - 1),
                    (c = a));
              });
          }
          var b;
          (b = v()),
            (l(i) && b.length == i.rows.length) ||
              (e(b.reverse(), function (b) {
                a(b);
              }),
              z());
        }
        ...
        function S(b, c) {
          var h,
            ...
            l = [];
          b &&
            ((h = d.splitAt(Z, _.x, _.y, c)),
            (i = h.row),
            a.each(h.cells, p),
            (j = a.map(b, function (a) {
            ...
            e(j, function (a, b, d) {
              ...
              for (h = $; h < q; h++)
                (j = a.cells[a.cells.length - 1]),
                  (m = f(j, "colspan")),
                  m > 1 ? g(j, "colSpan", m - 1) : ca.remove(j);
        ...
        function X(a, b) {
          ...
          do {
            ...
            if (e.elm != a)
              return (
                ba.select(e.elm, !0), ca.isEmpty(e.elm) && ba.collapse(!0), !0
              );
          } while (e.elm == a);
          return !1;
        }
        ...
        var Z,
          ...
          ba = h.selection,
          ca = ba.dom;
        (i = i || ca.getParent(ba.getStart(!0), "table")),
          n(),
          (j = j || ca.getParent(ba.getStart(!0), "th,td")),
          j && ((_ = T(j)), (aa = V()), (j = r(_.x, _.y))),
          a.extend(this, {
            deleteTable: x,
            split: B,
            merge: H,
    ...
    g("7", ["6", "1", "4"], function (a, b, c) {
      return function (d, e) {
        ...
        function h(b) {
          ...
          if (!m && !n && h !== l && ((l = h), k && j)) {
            if (
              ((f = o.getParent(h, "td,th")),
              g(k, f) || (f = o.getParent(k, "td,th")),
              j === f && !p)
            )
              return;
            if ((e(!0), g(k, f))) {
              b.preventDefault(),
                i ||
                  ((i = new a(d, k, j)),
                  (d.getBody().style.webkitUserSelect = "none")),
                i.setEndCell(f),
                (p = !0),
        ...
        return (
          ...
          d.on("MouseDown", function (a) {
            2 == a.button ||
              ...
              n ||
              (f(),
              (j = o.getParent(a.target, "td,th")),
              (k = o.getParent(j, "table")));
          }),
          d.on("mouseover", h),
          ...
          d.on("MouseUp", function () {
            ...
            if (j) {
              if (
                (i && (d.getBody().style.webkitUserSelect = ""),
                (f = o.select("td[data-mce-selected],th[data-mce-selected]")),
                f.length > 0)
              ) {
                (e = o.createRng()),
                  (h = f[0]),
                  ...
                  e.setEndAfter(h),
                  a(h, 1),
                  (g = new b(h, o.getParent(f[0], "table")));
                do
        ...
        function n(a, b, d) {
          ...
          c(d, function (a) {
            ...
            a.setAttrib(
              b,
              "style",
              a.serializeStyle(a.parseStyle(a.serializeStyle(e))),
            );
        }
        var o = this;
        (o.tableProps = function () {
          ...
          (o.table = function (e) {
            function j() {
              ...
              l(v, this),
                ...
                d.undoManager.transact(function () {
                  if (
                    (p ||
                      (p = d.plugins.table.insertTable(
                        w.cols || 1,
                        w.rows || 1,
                      )),
                    d.dom.setAttribs(p, { style: w.style, class: w["class"] }),
                    d.settings.table_style_by_css)
                  ) {
                    if (
                      ((u = []),
                      u.push({ name: "border", value: w.border }),
                      u.push({
                        name: "border-spacing",
                      ...
                      for (var a = 0; a < p.children.length; a++)
                        c(p.children[a], "border", w.border),
                          c(p.children[a], "padding", h(w.cellpadding));
                  } else
                    d.dom.setAttribs(p, {
                      border: w.border,
                  ...
                  v.getAttrib(p, "width") && !d.settings.table_style_by_css
                    ? v.setAttrib(p, "width", g(w.width))
                    : v.setStyle(p, "width", h(w.width)),
            ...
            var p,
              ...
              w = {};
            e === !0
              ? ((p = v.getParent(d.selection.getStart(), "table")),
                p &&
                  ((w = {
                    width: g(v.getStyle(p, "width") || v.getAttrib(p, "width")),
                    height: g(
                      v.getStyle(p, "height") || v.getAttrib(p, "height"),
                    ),
                    cellspacing: g(
                      v.getStyle(p, "border-spacing") ||
                        v.getAttrib(p, "cellspacing"),
                    ),
                    cellpadding:
                      v.getAttrib(p, "data-mce-cell-padding") ||
                      v.getAttrib(p, "cellpadding") ||
                      o(p, "padding"),
                    border:
                      v.getAttrib(p, "data-mce-border") ||
                      v.getAttrib(p, "border") ||
                      o(p, "border"),
              ...
              : ((q = { label: "Cols", name: "cols" }),
                (r = { label: "Rows", name: "rows" })),
              d.settings.table_class_list &&
                (w["class"] &&
                  (w["class"] = w["class"].replace(
                ...
                items: [
                  {
                    ...
                    items:
                      d.settings.table_appearance_options !== !1
                        ? [
                            q,
                            r,
          ...
          (o.cell = function () {
                ...
                d.undoManager.transact(function () {
                  c(s, function (a) {
                    b(a, "scope", p.scope),
                      ...
                      b(a, "class", p["class"]),
                      e(a, "width", h(p.width)),
                      e(a, "height", h(p.height)),
                      p.type &&
                        a.nodeName.toLowerCase() !== p.type &&
                        (a = r.rename(a, p.type)),
                      1 === s.length && (i(a), j(a)),
                      p.align && d.formatter.apply("align" + p.align, {}, a),
                      p.valign && d.formatter.apply("valign" + p.valign, {}, a);
                  }),
                    d.focus();
                });
            }
            ...
            if (
              ...
              (o = d.dom.getParent(d.selection.getStart(), "td,th")),
              !s.length && o && s.push(o),
              (o = o || s[0]))
            ) {
              s.length > 1
                ...
                : ((p = {
                    ...
                    height: g(
                      r.getStyle(o, "height") || r.getAttrib(o, "height"),
                    ),
                    scope: r.getAttrib(o, "scope"),
                    class: r.getAttrib(o, "class"),
                  }),
                  (p.type = o.nodeName.toLowerCase()),
                  c("left center right".split(" "), function (a) {
                  ...
                  m(r, p, o)),
                d.settings.table_cell_class_list &&
                  (q = {
                    name: "class",
                    type: "listbox",
                    label: "Class",
              ...
              d.settings.table_cell_advtab !== !1
                ? d.windowManager.open({
                    title: "Cell properties",
                    bodyType: "tabpanel",
                    data: p,
                    body: [{ title: "General", type: "form", items: t }, f(r)],
                    onsubmit: n,
                  })
                : d.windowManager.open({
                    title: "Cell properties",
          ...
          (o.row = function () {
                ...
                d.undoManager.transact(function () {
                  ...
                  c(u, function (c) {
                    b(c, "scope", r.scope),
                      b(c, "style", r.style),
                      b(c, "class", r["class"]),
                      e(c, "height", h(r.height)),
                      a !== c.parentNode.nodeName.toLowerCase() &&
                        ((f = t.getParent(c, "table")),
                        (g = c.parentNode),
                        (j = t.select(a, f)[0]),
                        j ||
                          ((j = t.create(a)),
                          f.firstChild
                            ...
                            : f.appendChild(j)),
                        j.appendChild(c),
                        g.hasChildNodes() || t.remove(g)),
                      1 === u.length && i(c),
                      r.align && d.formatter.apply("align" + r.align, {}, c);
                  }),
                    d.focus();
                });
            }
            var n,
              ...
              t = d.dom,
              u = [];
            (n = d.dom.getParent(d.selection.getStart(), "table")),
              (o = d.dom.getParent(d.selection.getStart(), "td,th")),
              c(n.rows, function (a) {
                c(a.cells, function (b) {
                  if (t.getAttrib(b, "data-mce-selected") || b == o)
                    return u.push(a), !1;
                });
              }),
              (p = u[0]),
              p &&
                (u.length > 1
                  ...
                  : ((r = {
                      height: g(
                        t.getStyle(p, "height") || t.getAttrib(p, "height"),
                      ),
                      scope: t.getAttrib(p, "scope"),
                      class: t.getAttrib(p, "class"),
                    }),
                    (r.type = p.parentNode.nodeName.toLowerCase()),
                    c("left center right".split(" "), function (a) {
                      d.formatter.matchNode(p, "align" + a) && (r.align = a);
                    }),
                    m(t, r, p)),
                d.settings.table_row_class_list &&
                  (q = {
                    name: "class",
                    type: "listbox",
                    label: "Class",
    ...
    g("9", ["4", "5"], function (a, b) {
      ...
      return function (d) {
        function e(a, b) {
          return { index: a, y: d.dom.getPos(b).y };
        }
        function f(a, b) {
          return { index: a, y: d.dom.getPos(b).y + b.offsetHeight };
        }
        function g(a, b) {
          return { index: a, x: d.dom.getPos(b).x };
        }
        function h(a, b) {
          return { index: a, x: d.dom.getPos(b).x + b.offsetWidth };
        }
        function i() {
          var a = d.getBody().dir;
          return "rtl" === a;
        ...
        function y(b) {
          return a.map(b.rows, function (b) {
            var c = a.map(b.cells, function (a) {
              var b = a.hasAttribute("rowspan")
                  ? parseInt(a.getAttribute("rowspan"), 10)
                  : 1,
                c = a.hasAttribute("colspan")
                  ? parseInt(a.getAttribute("colspan"), 10)
                  : 1;
          ...
          return (
            a.each(b, function (b, d) {
              ...
              a.each(b.cells, function (a) {
                ...
                h.push({ element: b.element, cells: e });
            }),
            {
              grid: { maxRows: i, maxCols: j },
              getAt: d,
              getAllCells: e,
              getAllRows: f,
            }
        ...
        function F(a, b, c, d) {
          ...
          var e = a[b];
          if (e) e = { value: e, delta: 0 };
          else
            for (var f = a.slice(0, b).reverse(), g = 0; g < f.length; g++)
              f[g] && (e = { value: f[g], delta: g + 1 });
          var h = a[b + 1];
          if (h) h = { value: h, delta: 1 };
          else
            for (var i = a.slice(b + 1), j = 0; j < i.length; j++)
              i[j] && (h = { value: i[j], delta: j + 1 });
        ...
        function G(a, b) {
          ...
          return (
            c || (c = d.dom.getAttrib(a, b)),
            c || (c = d.dom.getStyle(a, b, !0)),
            c
          );
        }
        function H(a, b, c) {
        ...
        function I(b, c, d) {
          for (
            ...
            var i = e[h].element.hasAttribute("colspan")
                ? parseInt(e[h].element.getAttribute("colspan"), 10)
                : 1,
        ...
        function K(b) {
          for (
            ...
            var h = c[g].element.hasAttribute("rowspan")
                ? parseInt(c[g].element.getAttribute("rowspan"), 10)
                : 1,
        ...
        function S(b, c, e) {
          function f(b, c) {
            a.each(b, function (a) {
              d.dom.setStyle(a.element, "width", a.width + c),
                d.dom.setAttrib(a.element, "width", null);
            });
          }
          function g() {
          ...
          function i(a, c, f) {
            (e != k.grid.maxCols - 1 && f) ||
              (d.dom.setStyle(b, "width", a + c),
              d.dom.setAttrib(b, "width", null));
          }
          for (
            var j = y(b),
              k = z(j),
              l = Q(b.width) || Q(b.style.width),
              m = I(k, l, b),
              n = l ? q(b, c) : c,
              s = L(m, e, n, va, l, b),
              t = [],
        ...
        function T(b, c, e) {
          for (
            var f = y(b), g = z(f), h = K(g), i = [], j = 0, k = 0;
            k < h.length;
            k++
          )
          ...
          d.undoManager.transact(function () {
            a.each(m, function (a) {
              d.dom.setStyle(a.element, "height", a.height + "px"),
                d.dom.setAttrib(a.element, "height", null);
            }),
              a.each(l, function (a) {
                d.dom.setStyle(a.element, "height", a.height + "px"),
                  d.dom.setAttrib(a.element, "height", null);
              }),
              d.dom.setStyle(b, "height", j + "px"),
              d.dom.setAttrib(b, "height", null);
          });
        }
        function U() {
          ...
          if ((d.dom.remove(ha), ga)) {
            ...
            if ($(ia)) {
              var e = parseInt(d.dom.getAttrib(ia, ta), 10),
                f = d.dom.getPos(ia).x;
              (a = parseInt(d.dom.getAttrib(ia, sa), 10)),
                (b = i() ? e - f : f - e),
                Math.abs(b) >= 1 && S(c, b, a);
            } else if (_(ia)) {
              var g = parseInt(d.dom.getAttrib(ia, pa), 10),
                h = d.dom.getPos(ia).y;
              (a = parseInt(d.dom.getAttrib(ia, oa), 10)),
                (b = h - g),
                Math.abs(b) >= 1 && T(c, b, a);
            }
            u(c), d.nodeChanged();
          }
        }
            ...
            if ("TABLE" === c.nodeName) {
              ...
              a.each(c.rows, function (b) {
                a.each(b.cells, function (a) {
                  ...
                  e.push({ cell: a, width: b });
                });
              }),
                a.each(e, function (a) {
                  d.dom.setStyle(a.cell, "width", a.width),
                    d.dom.setAttrib(a.cell, "width", null);
                });
            }
          }),
    ...
    g("a", ["5", "e", "2", "4", "c"], function (a, b, c, d, e) {
      var f = d.each,
        g = e.getSpanVal;
      return function (h) {
        function i() {
          function c(c) {
            ...
            function t(a, b) {
              return (
                h.dom.getParent(a, "TABLE") === h.dom.getParent(b, "TABLE")
              );
            }
            var u = c.keyCode;
            if (n() && o(h)) {
        ...
        function j() {
          ...
          h.on("KeyDown", function (b) {
            ...
            (37 != b.keyCode && 38 != b.keyCode) ||
              ((c = h.selection.getRng()),
              (d = e.getParent(c.startContainer, "table")),
              d &&
                h.getBody().firstChild == d &&
                a(c, d) &&
                ((c = e.createRng()),
                c.setStartBefore(d),
                c.setEndBefore(d),
          ...
          h.on("KeyDown SetContent VisualAid", function () {
            ...
            for (a = h.getBody().lastChild; a; a = a.previousSibling)
              if (3 == a.nodeType) {
                ...
                1 == a.nodeType &&
                ("BR" == a.tagName || !a.getAttribute("data-mce-bogus"))
              )
                break;
            a &&
              "TABLE" == a.nodeName &&
              (h.settings.forced_root_block
                ? h.dom.add(
                    h.getBody(),
                    h.settings.forced_root_block,
                    h.settings.forced_root_block_attrs,
                    c.ie && c.ie < 10 ? "&nbsp;" : '<br data-mce-bogus="1" />',
                  )
                : h.dom.add(h.getBody(), "br", { "data-mce-bogus": "1" }));
          }),
              ...
              b &&
                ("BR" == b.nodeName ||
                  (1 == b.childNodes.length &&
                    ("BR" == b.firstChild.nodeName ||
                      "\xa0" == b.firstChild.nodeValue))) &&
                b.previousSibling &&
                "TABLE" == b.previousSibling.nodeName &&
                h.dom.remove(b);
            });
        }
        function l() {
          ...
          function b() {
            ...
            if (a(h, b, c, d)) {
              ...
              3 == e.nodeType &&
                (b.setEnd(e, e.data.length), h.selection.setRng(b));
            }
          }
        ...
        function m() {
          ...
          h.on("keydown", function (e) {
            if (
              (e.keyCode == a.DELETE || e.keyCode == a.BACKSPACE) &&
              !e.isDefaultPrevented()
            ) {
              var f, g, i, j;
              if ((f = h.dom.getParent(h.selection.getStart(), "table"))) {
                if (
                  ((g = h.dom.select("td,th", f)),
                  (i = d.grep(g, function (a) {
                    return !!h.dom.getAttrib(a, "data-mce-selected");
                  })),
                  0 === i.length)
                )
                  return (
                    (j = h.dom.getParent(h.selection.getStart(), "td,th")),
                    void (
                      h.selection.isCollapsed() &&
                      j &&
                      h.dom.isEmpty(j) &&
                      (e.preventDefault(), c(j), b(j))
                    )
                  );
                e.preventDefault(),
                  h.undoManager.transact(function () {
                    g.length == i.length
                      ? h.execCommand("mceTableDelete")
                      : (d.each(i, c), b(i[0]));
                  });
              }
            }
        ...
        function n() {
          var b = "\ufeff",
            c = function (a) {
              return (
                h.dom.isEmpty(a) ||
                (a.firstChild === a.lastChild && f(a.firstChild))
              );
            },
            d = function (a) {
              return (
                a && "CAPTION" == a.nodeName && "TABLE" == a.parentNode.nodeName
              );
            },
            e = function (a, b) {
              var c = b.firstChild;
            ...
            i = function (a, c) {
              ...
              (d = c
                ? h.dom.create(
                    "p",
                    { "data-mce-caret": "after", "data-mce-bogus": "all" },
                    '<br data-mce-bogus="1">',
                  )
            ...
            j = function (a, d) {
              var e = a.lastChild,
                ...
                k = g.startOffset;
              c(a)
                ? ((a.innerHTML = b), (j = a.lastChild), (k = 0))
                : f(e) || i(a, h.dom.isBlock(e)),
                h.selection.setCursorLocation(j, k);
            },
            k = function (a) {
              var b = h.selection.getRng(),
                c = h.dom.createRng(),
              ...
              b.commonAncestorContainer === a.parentNode &&
                ...
                1 === d.nodeType
                  ...
                  : c.setEnd(d, d.nodeValue.length),
                h.selection.setRng(c));
            };
          h.on("keydown", function (b) {
            if (
              !(
                (b.keyCode !== a.DELETE && b.keyCode !== a.BACKSPACE) ||
      ...
      function (a, b, c, d, e, f, g, h, i, j) {
        function k(a) {
          ...
          function d(c, d) {
            ...
            return (
              ...
              a.undoManager.transact(function () {
                a.insertContent(g),
                  (h = a.dom.get("__mce")),
                  a.dom.setAttrib(h, "id", null),
                  a.$("tr", h).each(function (b, c) {
                    a.fire("newrow", { node: c }),
                      a.$("th,td", c).each(function (b, c) {
                        a.fire("newcell", { node: c });
                      });
                  }),
                  a.dom.setAttribs(
                    h,
                    a.settings.table_default_attributes || {},
                  ),
          ...
          function k(b, c, d) {
            function e() {
              var e,
                ...
                h = {},
                i = 0;
              (f = a.dom.select("td[data-mce-selected],th[data-mce-selected]")),
                (e = f[0]),
                e || (e = a.selection.getStart()),
                d && f.length > 0
                  ? (l(f, function (a) {
                    ...
                    (g = 1 !== i))
                  : (g = !a.dom.getParent(e, c)),
                b.disabled(g),
                a.selection.selectorChanged(c, function (a) {
                  b.disabled(!a);
                });
            }
          ...
          function q(b, c, d) {
            ...
            for (
              j.nextSibling.innerHTML = b + 1 + " x " + (c + 1),
                k && (b = 9 - b),
                f = 0;
              f < 10;
              f++
              ...
              for (e = 0; e < 10; e++)
                (h = j.rows[f].childNodes[e].firstChild),
                  (i = (k ? e >= b : e <= b) && f <= c),
                  a.dom.toggleClass(h, "mce-active", i),
                  i && (g = h);
            return g.parentNode;
          }
          function r() {
          ...
          var w,
            ...
            y = this,
            z = new h(a);
          !a.settings.object_resizing ||
            a.settings.table_resize_bars === !1 ||
            (a.settings.object_resizing !== !0 &&
              "table" !== a.settings.object_resizing) ||
            (x = i(a)),
            a.settings.table_grid === !1
              ...
              : a.addMenuItem("inserttable", {
                  ...
                  onhide: function () {
                    ...
                    a.dom.removeClass(b, "mce-active"),
                      a.dom.addClass(b[0], "mce-active");
                  },
                  menu: [
                    {
                      type: "container",
                      ...
                      onmousemove: function (a) {
                        ...
                        "A" == d.tagName.toUpperCase() &&
                          ((b = parseInt(d.getAttribute("data-mce-x"), 10)),
                          (c = parseInt(d.getAttribute("data-mce-y"), 10)),
                          (this.isRtl() || "tl-tr" == this.parent().rel) &&
                            (b = 9 - b),
                          (b === this.lastX && c === this.lastY) ||
                            (q(b, c, a.control),
                            (this.lastX = b),
                            (this.lastY = c)));
                      },
                      onclick: function (b) {
                        var c = this;
                        "A" == b.target.tagName.toUpperCase() &&
                          (b.preventDefault(),
                          b.stopPropagation(),
                          c.parent().cancel(),
                          a.undoManager.transact(function () {
                            d(c.lastX + 1, c.lastY + 1);
                          }),
                          a.addVisual());
                      },
                    },
          ...
          l(
            ...
            function (b) {
              "|" == b ? A.push({ text: "-" }) : A.push(a.menuItems[b]);
            },
          ),
            a.addButton("table", {
              type: "menubutton",
            ...
            b.isIE ||
              a.on("click", function (b) {
                (b = b.target),
                  "TABLE" === b.nodeName &&
                    (a.selection.select(b), a.nodeChanged());
              }),
            (y.quirks = new j(a)),
            a.on("Init", function () {
              (y.cellSelection = new g(a, function (a) {
                a && x && x.clearBars();
              })),
                (y.resizeBars = x);
            }),
            a.on("PreInit", function () {
              a.serializer.addAttributeFilter(
            ...
            l(
              {
                ...
                mceTableMergeCells: function (b) {
                  var c;
                  (c = a.dom.getParent(a.selection.getStart(), "th,td")),
                    a.dom.select("td[data-mce-selected],th[data-mce-selected]")
                      .length
                      ? b.merge()
                      : z.merge(b, c);
                },
                ...
                mceSplitColsBefore: function (a) {
                  a.splitCols(!0);
                },
                mceSplitColsAfter: function (a) {
                  a.splitCols(!1);
                },
                mceTableDelete: function (a) {
                  x && x.clearBars(), a.deleteTable();
                },
              },
              function (b, c) {
                a.addCommand(c, function () {
                  ...
                  c &&
                    ...
                    y.cellSelection.clear());
                });
              },
            ),
            l(
              {
                mceInsertTable: z.table,
                mceTableProps: function () {
                  z.table(!0);
                },
                mceTableRowProps: z.row,
                mceTableCellProps: z.cell,
              },
              function (b, c) {
            ...
            r(),
            t(),
            a.settings.table_tab_navigation !== !1 &&
                  ...
                  (c = a.dom.getParent(h, "th,td")),
                    c &&
                      ...
                      a.undoManager.transact(function () {
                        !d.moveRelIdx(c, g) &&
                          g > 0 &&
                          (d.insertRow(), d.refresh(), d.moveRelIdx(c, g));
                      }));
                }
              }),
            (y.insertTable = d),
            (y.setClipboardRows = v),
            (y.getClipboardRows = u);
        }
        var l = d.each;
        return c.add("table", k), function () {};
      },
    ),
    d("0")();
})();
