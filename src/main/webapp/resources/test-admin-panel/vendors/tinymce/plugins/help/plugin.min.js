!(function () {
  ...
  h("3", tinymce.util.Tools.resolve),
    ...
    g("9", ["i"], function (a) {
      var b = a.mac ? "\u2318" : "Ctrl",
        c = a.mac ? "Ctrl + Alt" : "Shift + Alt",
        d = [
          { shortcut: b + " + B", action: "Bold" },
          { shortcut: b + " + I", action: "Italic" },
          { shortcut: b + " + U", action: "Underline" },
          { shortcut: b + " + A", action: "Select All" },
          { shortcut: b + " + Y or " + b + " + Shift + Z", action: "Redo" },
          { shortcut: b + " + Z", action: "Undo" },
          { shortcut: c + " + 1", action: "Header 1" },
          { shortcut: c + " + 2", action: "Header 2" },
          { shortcut: c + " + 3", action: "Header 3" },
          { shortcut: c + " + 4", action: "Header 4" },
          { shortcut: c + " + 5", action: "Header 5" },
          { shortcut: c + " + 6", action: "Header 6" },
          { shortcut: c + " + 7", action: "Paragraph" },
          { shortcut: c + " + 8", action: "Div" },
          { shortcut: c + " + 9", action: "Address" },
          ...
          { shortcut: b + " + S", action: "Save (if save plugin activated)" },
          {
            shortcut: b + " + F",
      ...
      var c = function () {
        var c = function (a) {
            return (
              ...
              a.action +
              ", Shortcut: " +
              a.shortcut.replace(/Ctrl/g, "Control") +
              '"'
            );
          },
          d = a
            .map(b.shortcuts, function (a) {
              return (
          ...
          items: [
            {
              type: "container",
              html:
                '<div><table class="mce-table-striped"><thead><th>Action</th><th>Shortcut</th></thead>' +
                d +
                "</table></div>",
            },
          ],
    ...
    g("6", ["4", "a", "8", "b", "c", "d"], function (a, b, c, d, e, f) {
      var g = function (a) {
          return c
            .find(f.urls, function (b) {
              return b === a;
            })
            .fold(d.constant(a), function (a) {
              return e.supplant(
                '<a href="${url}" target="_blank">${name}</a>',
                { name: a, url: "https://www.tinymce.com/docs/plugins/" + a },
              );
            });
        },
        h = function (a) {
          var c = b.mapToArray(a.plugins, function (a, b) {
              return "<li>" + g(b) + "</li>";
            }),
            d = c.length,
            e = c.join("");
          return (
            "<p><b>Plugins installed (" + d + "):</b></p><ul>" + e + "</ul>"
          );
        },
        i = function (a) {
          return {
        ...
        j = function () {
          return {
            type: "container",
            html: '<div style="padding: 10px; background: #e3e7f4; height: 100%;" data-mce-tabstop="1" tabindex="-1"><p><b>Premium plugins:</b></p><ul><li>PowerPaste</li><li>Spell Checker Pro</li><li>Accessibility Checker</li><li>Advanced Code Editor</li><li>Enhanced Media Embed</li><li>Link Checker</li></ul><br /><p style="float: right;"><a href="https://www.tinymce.com/pricing/" target="_blank">Learn more...</a></p></div>',
            flex: 1,
          };
        },
        k = function (a) {
    ...
    g("7", ["4"], function (a) {
      var b = function (a, b) {
          return 0 === a.indexOf("@") ? "X.X.X" : a + "." + b;
        },
        c = function () {
          var c = b(a.majorVersion, a.minorVersion),
            d =
              '<a href="https://www.tinymce.com/docs/changelog/" target="_blank">TinyMCE ' +
              c +
              "</a>";
          return [
            { type: "label", html: "You are using " + d },
            { type: "spacer", flex: 1 },
            {
              text: "Close",
              onclick: function () {
      ...
      var e = function (a, e) {
        return function () {
          a.windowManager.open({
            ...
            bodyType: "tabpanel",
            layout: "flex",
            body: [b.makeTab(), c.makeTab(a, e)],
            buttons: d.makeRow(),
            onPostRender: function () {
              var a = this.getEl("title");
              a.innerHTML =
                '<img src="' +
                e +
    ...
    g("0", ["1", "2"], function (a, b) {
      var c = function (a, c) {
        a.addButton("help", { icon: "help", onclick: b.openDialog(a, c) }),
          a.addMenuItem("Help", {
            text: "Help",
            icon: "help",
            context: "view",
            onclick: b.openDialog(a, c),
          }),
          a.addCommand("mceHelp", b.openDialog(a, c)),
          a.shortcuts.add("Alt+0", "Open help dialog", b.openDialog(a, c));
      };
      return a.add("help", c), function () {};
    }),
    d("0")();
})();
