!(function () {
  ...
  h("3", tinymce.util.Tools.resolve),
    ...
    g("0", ["1", "2"], function (a, b) {
      return (
        a.add("colorpicker", function (a) {
          function c(c, d) {
            function e(a) {
              var c = new b(a),
                d = c.toRgb();
              g.fromJSON({ r: d.r, g: d.g, b: d.b, hex: c.toHex().substr(1) }),
                f(c.toHex());
            }
            function f(a) {
              g.find("#preview")[0].getEl().style.background = a;
            }
                ...
                items: [
                  {
                    ...
                    onchange: function () {
                      ...
                      g &&
                        ...
                        g.find("#g").value(a.g),
                        g.find("#b").value(a.b),
                        g.find("#hex").value(this.value().substr(1)),
                        f(this.value()));
                    },
                  },
                  {
                    ...
                    defaults: {
                      ...
                      onchange: function () {
                        var a,
                          b,
                          c = g.find("colorpicker")[0];
                        return (
                          (a = this.name()),
                          (b = this.value()),
                          "hex" == a
                            ? ((b = "#" + b), e(b), void c.value(b))
                            : ((b = {
                                r: g.find("#r").value(),
                                g: g.find("#g").value(),
                                b: g.find("#b").value(),
          ...
          a.settings.color_picker_callback ||
            (a.settings.color_picker_callback = c);
        }),
        function () {}
      );
    }),
