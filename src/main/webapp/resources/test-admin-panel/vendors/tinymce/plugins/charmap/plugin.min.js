        ...
        a.add("charmap", function (a) {
          ...
          function d(a) {
            return b.grep(a, function (a) {
              return j(a) && 2 == a.length;
            });
          }
          function e(a) {
            return j(a) ? [].concat(d(a)) : "function" == typeof a ? a() : [];
          }
          function f(b) {
            var c = a.settings;
            return (
              c.charmap && (b = e(c.charmap)),
              c.charmap_append ? [].concat(b).concat(e(c.charmap_append)) : b
            );
          }
          function g() {
            return f(c());
          ...
          function h(b) {
            a.fire("insertCustomChar", { chr: b }).chr,
          ...
          function i() {
            ...
            for (e = 0; e < k; e++) {
              for (c += "<tr>", d = 0; d < j; d++) {
                ...
                if (l < i.length) {
                  var m = i[l],
                    n = m ? String.fromCharCode(parseInt(m[0], 10)) : "&nbsp;";
                  c +=
                    '<td title="' +
                    m[1] +
            ...
            var o = {
              ...
              onclick: function (a) {
                var c = a.target;
                if (/^(TD|DIV)$/.test(c.nodeName)) {
                  var d = b(c).firstChild;
                  d &&
                    d.hasAttribute("data-chr") &&
                    (h(d.getAttribute("data-chr")), a.ctrlKey || f.close());
                }
              },
              onmouseover: function (a) {
                var c = b(a.target);
                c && c.firstChild
                  ? (f.find("#preview").text(c.firstChild.firstChild.data),
                    f.find("#previewTitle").text(c.title))
                  : (f.find("#preview").text(" "),
                    f.find("#previewTitle").text(" "));
              },
            };
            f = a.windowManager.open({
