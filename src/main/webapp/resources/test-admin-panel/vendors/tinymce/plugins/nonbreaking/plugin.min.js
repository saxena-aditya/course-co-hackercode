!(function () {
  ...
  h("2", tinymce.util.Tools.resolve),
    g("1", ["2"], function (a) {
      return a("tinymce.PluginManager");
    }),
    g("0", ["1"], function (a) {
      return (
        a.add("nonbreaking", function (a) {
          var b = a.getParam("nonbreaking_force_tab");
          if (
            (a.addCommand("mceNonBreaking", function () {
              a.insertContent(
                a.plugins.visualchars && a.plugins.visualchars.state
                  ? '<span class="mce-nbsp">&nbsp;</span>'
                  : "&nbsp;",
              ),
                a.dom.setAttrib(
                  a.dom.select("span.mce-nbsp"),
                  "data-mce-bogus",
                  "1",
                );
            }),
            ...
            a.on("keydown", function (b) {
              if (9 == b.keyCode) {
                ...
                b.preventDefault();
                for (var d = 0; d < c; d++) a.execCommand("mceNonBreaking");
              }
            });
          }
        }),
