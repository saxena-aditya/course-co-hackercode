    ...
    g("0", ["1", "2", "3", "4", "5"], function (a, b, c, d, e) {
      return (
        d.add("importcss", function (d) {
          ...
          function g(b) {
            var c = d.settings,
              e = c.skin !== !1 && (c.skin || "lightgray");
            if (e) {
              var f = c.skin_url;
              return (
                (f = f
                  ? d.documentBaseURI.toAbsolute(f)
                  : a.baseURL + "/skins/" + e),
                b === f + "/content" + (d.inline ? ".inline" : "") + ".min.css"
              );
            }
            return !1;
          }
              ...
              if (((j = f(j)), j && b(j, d) && !g(j))) {
                ...
                r(i, function (a) {
                  a.styleSheet
                    ? c(a.styleSheet, !0)
                    : a.selectorText &&
                      r(a.selectorText.split(","), function (a) {
                        h.push(e.trim(a));
                      });
                });
              }
          ...
          function j(a) {
            var b,
              c = /^(?:([a-z0-9\-_]+))?(\.[a-z0-9_\-\.]+)$/i.exec(a);
            if (c) {
              var f = c[1],
                g = c[2].substr(1).split(".").join(" "),
                h = e.makeMap("a,img");
              return (
                c[1]
                  ? ((b = { title: a }),
                    d.schema.getTextBlockElements()[f]
                      ? (b.block = f)
                      : d.schema.getBlockElements()[f] || h[f.toLowerCase()]
                        ? (b.selector = f)
                        : (b.inline = f))
                  : c[2] &&
                    (b = { inline: "span", title: a.substr(1), classes: g }),
                d.settings.importcss_merge_classes !== !1
                  ? (b.classes = g)
                  : (b.attributes = { class: g }),
                b
              );
            }
          }
          ...
          function p(a, b, c) {
            ...
            return (
              (e =
                c && c.selector_converter
                  ? c.selector_converter
                  : f.importcss_selector_converter
                    ? f.importcss_selector_converter
                    : j),
              e.call(a, b, c)
            );
          ...
          var q = this,
            r = e.each;
          d.on("renderFormatsMenu", function (a) {
            var c = d.settings,
              f = {},
              g = h(c.importcss_selector_filter),
              j = a.control,
              m = l(c.importcss_groups),
              s = function (a, c) {
                if (n(a, c, f)) {
                  o(a, c, f);
                  var g = p(q, a, c);
                  if (g) {
                    var h = g.name || b.DOM.uniqueId();
                    return (
                      d.formatter.register(h, g),
                      e.extend({}, j.settings.itemDefaults, {
                        text: g.title,
                        format: h,
                      })
                    );
            ...
            d.settings.importcss_append || j.items().remove(),
              r(
                i(a.doc || d.getDoc(), h(c.importcss_file_filter)),
                function (a) {
