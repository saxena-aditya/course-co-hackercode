!(function () {
  ...
  h("3", tinymce.util.Tools.resolve),
    ...
    g("0", ["1", "2"], function (a, b) {
      return (
        a.add("pagebreak", function (a) {
          var c = "mce-pagebreak",
            d = a.getParam("pagebreak_separator", "<!-- pagebreak -->"),
            e = new RegExp(
          ...
          a.addCommand("mcePageBreak", function () {
            ...
            a.on("ResolveName", function (b) {
              "IMG" == b.target.nodeName &&
                a.dom.hasClass(b.target, c) &&
                (b.name = "pagebreak");
            }),
            a.on("click", function (b) {
              (b = b.target),
                "IMG" === b.nodeName &&
                  a.dom.hasClass(b, c) &&
                  a.selection.select(b);
            }),
            a.on("BeforeSetContent", function (a) {
              a.content = a.content.replace(e, f);
            }),
            a.on("PreInit", function () {
              a.serializer.addNodeFilter("img", function (b) {
                for (var c, e, f = b.length; f--; )
                  if (
                    ((c = b[f]),
                    (e = c.attr("class")),
                    e && e.indexOf("mce-pagebreak") !== -1)
                  ) {
                    var g = c.parent;
                    if (
                      a.schema.getBlockElements()[g.name] &&
                      a.settings.pagebreak_split_block
                    ) {
                      (g.type = 3), (g.value = d), (g.raw = !0), c.remove();
                      continue;
                    }
                    (c.type = 3), (c.value = d), (c.raw = !0);
                  }
              });
            });
        }),
