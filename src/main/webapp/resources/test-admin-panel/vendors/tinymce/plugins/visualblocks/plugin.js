...
jsc*/
   ...
   * @private
   */
  define("tinymce.plugins.visualblocks.Plugin", [
    ...
    PluginManager.add("visualblocks", function (editor, url) {
      ...
      function toggleActiveState() {
        ...
        editor.on("VisualBlocks", function () {
          self.active(
            editor.dom.hasClass(editor.getBody(), "mce-visualblocks"),
          );
        });
      }
      ...
      editor.addCommand("mceVisualBlocks", function () {
        ...
        if (visualBlocksMenuItem) {
          visualBlocksMenuItem.active(
            dom.hasClass(editor.getBody(), "mce-visualblocks"),
          );
        }
      ...
      editor.on("init", function () {
        if (editor.settings.visualblocks_default_state) {
          editor.execCommand("mceVisualBlocks", false, null, {
            skip_focus: true,
          });
        }
      });
