...
jsc*/
  ...
  define("tinymce.plugins.link.core.Settings", [], function () {
  ...
  define("tinymce.plugins.link.core.Utils", [
    ...
    var isImageFigure = function (node) {
      return (
        node && node.nodeName === "FIGURE" && /\bimage\b/i.test(node.className)
      );
    };
      ...
      return function (data) {
        editor.undoManager.transact(function () {
          ...
          if (
            ...
            linkAttrs.rel = toggleTargetRules(
              linkAttrs.rel,
  ...
  define("tinymce.plugins.link.ui.Dialog", [
    ...
    var showDialog = function (editor, linkList) {
      ...
      data.text = initialText = Utils.getAnchorText(
        editor.selection,
        anchorElm,
      );
          ...
          values: buildListItems(
            ...
            function (item) {
              if (Settings.allowUnsafeLinkTarget(editor.settings) === false) {
                item.value = Utils.toggleTargetRules(
                  item.value,
                  data.target === "_blank",
                );
              }
      ...
      win = editor.windowManager.open({
        ...
        onSubmit: function (e) {
          var assumeExternalTargets = Settings.assumeExternalTargets(
            editor.settings,
          );
  ...
  define("tinymce.plugins.link.core.OpenUrl", [
  ...
  define("tinymce.plugins.link.core.Actions", [
    ...
    var toggleActiveState = function (editor) {
      return function () {
        ...
        editor.on("nodechange", function (e) {
          self.active(
            !editor.readonly && !!Utils.getAnchorElement(editor, e.element),
          );
        });
      };
    };
    ...
    var toggleViewLinkState = function (editor) {
      return function () {
        ...
        if (
          !Utils.hasLinks(editor.dom.getParents(editor.selection.getStart()))
        ) {
          self.hide();
        }
  ...
  define("tinymce.plugins.link.ui.Controls", [
  ...
  define("tinymce.plugins.link.Plugin", [
