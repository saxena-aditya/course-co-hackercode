  ...
  h("6", tinymce.util.Tools.resolve),
    ...
    g("3", [], function () {
            ...
            c = (b.Prism = {
              util: {
                encode: function (a) {
                  return a instanceof d
                    ? new d(a.type, c.util.encode(a.content), a.alias)
                    : "Array" === c.util.type(a)
                      ? a.map(c.util.encode)
                      : a
                          .replace(/&/g, "&amp;")
              ...
              languages: {
                ...
                DFS: function (a, b, d) {
                  for (var e in a)
                    a.hasOwnProperty(e) &&
                      (b.call(a, e, a[e], d || e),
                      "Object" === c.util.type(a[e])
                        ? c.languages.DFS(a[e], b)
                        : "Array" === c.util.type(a[e]) &&
                          c.languages.DFS(a[e], b, e));
                },
              },
              plugins: {},
              ...
              highlightElement: function (d, e, f) {
                for (var g, h, i = d; i && !a.test(i.className); )
                  i = i.parentNode;
                i &&
                  ((g = (i.className.match(a) || [, ""])[1]),
                  (h = c.languages[g])),
                  (d.className =
                    d.className.replace(a, "").replace(/\s+/g, " ") +
                    " language-" +
                    g),
                  (i = d.parentNode),
                  /pre/i.test(i.nodeName) &&
                    (i.className =
                      i.className.replace(a, "").replace(/\s+/g, " ") +
                      " language-" +
                      g);
                var j = d.textContent,
                  k = { element: d, language: g, grammar: h, code: j };
      ...
      return (
        ...
        c.languages.markup &&
          (c.hooks.add("before-highlight", function (a) {
            "php" === a.language &&
              ((a.tokenStack = []),
              (a.backupCode = a.code),
              (a.code = a.code.replace(
                ...
                function (b) {
                  return (
                    a.tokenStack.push(b), "{{{PHP" + a.tokenStack.length + "}}}"
                  );
                },
              )));
          }),
            ...
            if ("php" === a.language) {
              for (var b, d = 0; (b = a.tokenStack[d]); d++)
                a.highlightedCode = a.highlightedCode.replace(
                  "{{{PHP" + (d + 1) + "}}}",
                  c.highlight(b, a.grammar, "php").replace(/\$/g, "$$$$"),
                );
    ...
    g("5", [], function () {
      function a(a) {
        return (
          a && "PRE" == a.nodeName && a.className.indexOf("language-") !== -1
        );
      }
      function b(a) {
        return function (b, c) {
    ...
    g("4", ["7", "3", "5"], function (a, b, c) {
      function d(a) {
        var b = [
          ...
          c = a.settings.codesample_languages;
        return c ? c : b;
      }
      function e(a, c, d) {
        a.undoManager.transact(function () {
          ...
          (d = i.encode(d)),
            e
              ? (a.dom.setAttrib(e, "class", "language-" + c),
                (e.innerHTML = d),
                b.highlightElement(e),
                a.selection.select(e))
              : (a.insertContent(
                  '<pre id="__new" class="language-' + c + '">' + d + "</pre>",
                ),
                a.selection.select(a.$("#__new").removeAttr("id")[0]));
        });
      }
      function f(a) {
        var b = a.selection.getNode();
        return c.isCodeSample(b) ? b : null;
      }
      function g(a) {
        var b = f(a);
      ...
      function h(a) {
        var b,
          c = f(a);
        return c
          ? ((b = c.className.match(/language-(\w+)/)), b ? b[1] : "")
          : "";
      }
      var i = a.DOM;
      return {
        open: function (a) {
          a.windowManager.open({
            ...
            minWidth: Math.min(
              i.getViewPort().w,
              a.getParam("codesample_dialog_width", 800),
            ),
            minHeight: Math.min(
              i.getViewPort().h,
              a.getParam("codesample_dialog_height", 650),
            ),
            layout: "flex",
            direction: "column",
            align: "stretch",
            ...
            onSubmit: function (b) {
              e(a, b.data.language, b.data.code);
            },
          });
        },
      };
    ...
    g("0", ["1", "2", "3", "4", "5"], function (a, b, c, d, e) {
      ...
      return (
        b.add("codesample", function (b, h) {
          function i() {
            var a,
              c = b.settings.codesample_content_css;
            (b.inline && f) ||
              (!b.inline && j) ||
              (b.inline ? (f = !0) : (j = !0),
              c !== !1 &&
          ...
          a.ceFalse &&
            (b.on("PreProcess", function (a) {
              k("pre[contenteditable=false]", a.node)
                .filter(g(e.isCodeSample))
                .each(function (a, b) {
                  var c = k(b),
                    d = b.textContent;
            ...
            b.addCommand("codesample", function () {
              ...
              b.selection.isCollapsed() || e.isCodeSample(a)
                ? d.open(b)
