...
jsc*/
  ...
  define("tinymce.core.util.LocalStorage", [
    "global!tinymce.util.Tools.resolve",
  ], function (resolve) {
   ...
   * @private
   */
  define("tinymce.plugins.autosave.Plugin", [
    ...
    PluginManager.add("autosave", function (editor) {
      ...
      prefix =
        settings.autosave_prefix || "tinymce-autosave-{path}{query}-{id}-";
      ...
      settings.autosave_retention = parseTime(
        settings.autosave_retention,
        "20m",
      );
