...
jsc*/
   ...
   * @private
   */
  define("tinymce.plugins.toc.Plugin", [
    ...
    PluginManager.add("toc", function (editor) {
      ...
      function isToc(elm) {
        return (
          elm &&
          editor.dom.is(elm, "." + opts.className) &&
      ...
      editor.on("PreInit", function () {
        ...
        opts = {
          ...
          className: s.toc_class
            ? editor.dom.encode(s.toc_class)
            : defs.className,
        };
      });
      ...
      editor.addContextToolbar(isToc, "tocupdate");
