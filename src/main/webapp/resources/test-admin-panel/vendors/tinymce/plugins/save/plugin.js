...
jsc*/
   ...
   * @private
   */
  define("tinymce.plugins.save.Plugin", [
    ...
    PluginManager.add("save", function (editor) {
        ...
        if (formObj) {
          ...
          if (!formObj.onsubmit || formObj.onsubmit()) {
            if (typeof formObj.submit == "function") {
              ...
              displayErrorMessage(
                editor.translate("Error: Form submit field collision."),
              );
            }
          }
          ...
          displayErrorMessage(
            editor.translate("Error: No form element found."),
          );
        }
      }
      ...
      function stateToggle() {
        ...
        editor.on("nodeChange dirty", function () {
          self.disabled(
            editor.getParam("save_enablewhendirty", true) && !editor.isDirty(),
          );
        });
      }
