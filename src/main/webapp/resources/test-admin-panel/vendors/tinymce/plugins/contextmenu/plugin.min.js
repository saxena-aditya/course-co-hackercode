      ...
      return (
        c.add("contextmenu", function (a) {
          var c,
            ...
            n = function (a, b) {
              return (
                m(a.target) && f.isXYWithinRange(a.clientX, a.clientY, b) === !1
              );
            };
          return (
            ...
            a.on("contextmenu", function (b) {
              ...
              if (!j(b)) {
                if (
                  (n(b, a.selection.getRng()) && a.selection.select(b.target),
                  b.preventDefault(),
                  (f =
                    a.settings.contextmenu ||
                  ...
                  var i = [];
                  e.each(f.split(/[ ,]/), function (b) {
                    var c = a.menuItems[b];
                    "|" == b && (c = { text: b }),
                      c && ((c.shortcut = ""), i.push(c));
                  });
                  for (var k = 0; k < i.length; k++)
                    "|" == i[k].text &&
                      ((0 !== k && k != i.length - 1) || i.splice(k, 1));
                  (c = new d({
                    items: i,
                    context: "contextmenu",
                    classes: "contextmenu",
                  }).renderTo()),
                    c.on("hide", function (a) {
                      a.control === this && (h = !1);
                    }),
                ...
                var l = { x: b.pageX, y: b.pageY };
                a.inline ||
                  ((l = g.getPos(a.getContentAreaContainer())),
                  (l.x += b.clientX),
                  (l.y += b.clientY)),
                  c.moveTo(l.x, l.y),
                  (h = !0);
