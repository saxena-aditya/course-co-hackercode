        ...
        b.add("fullscreen", function (a) {
          function b() {
            var a,
              ...
              e = d.body;
            return (
              e.offsetWidth && ((a = e.offsetWidth), (b = e.offsetHeight)),
              c.innerWidth &&
                c.innerHeight &&
                ((a = c.innerWidth), (b = c.innerHeight)),
              { w: a, h: b }
            );
          }
          function d() {
          ...
          function f() {
            function f() {
              c.setStyle(
                p,
                "height",
                b().h - (o.clientHeight - p.clientHeight),
              );
            }
            var n,
              o,
            ...
            (m = !m),
              ...
              m
                ? ((l = d()),
                  ...
                  (k = n.height),
                  (n.width = n.height = ""),
                  c.addClass(r, "mce-fullscreen"),
                  c.addClass(s, "mce-fullscreen"),
                  c.addClass(o, "mce-fullscreen"),
                  c.bind(window, "resize", f),
                  f(),
                  (i = f))
                : ((q.width = g),
                  (q.height = h),
                  j && (n.width = j),
                  k && (n.height = k),
                  c.removeClass(r, "mce-fullscreen"),
                  c.removeClass(s, "mce-fullscreen"),
                  c.removeClass(o, "mce-fullscreen"),
                  c.unbind(window, "resize", i),
                  e(l)),
              a.fire("FullscreenStateChanged", { state: m });
          }
          var g,
            h,
            i,
            ...
            l,
            m = !1;
          if (!a.settings.inline)
            return (
              a.on("init", function () {
                a.addShortcut("Ctrl+Shift+F", "", f);
              }),
              a.on("remove", function () {
                i && c.unbind(window, "resize", i);
              }),
              a.addCommand("mceFullScreen", f),
              a.addMenuItem("fullscreen", {
                text: "Fullscreen",
