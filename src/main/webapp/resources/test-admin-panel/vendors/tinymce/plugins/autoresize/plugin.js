...
jsc*/
   ...
   * @private
   */
  define("tinymce.plugins.autoresize.Plugin", [
    ...
    PluginManager.add("autoresize", function (editor) {
      ...
      function resize(e) {
        ...
        if (isNaN(myHeight) || myHeight <= 0) {
          ...
          myHeight = Env.ie
            ? body.scrollHeight
            : Env.webkit && body.clientHeight === 0
              ? 0
              : body.offsetHeight;
        }
        ...
        if (
          settings.autoresize_max_height &&
          myHeight > settings.autoresize_max_height
        ) {
      ...
      settings.autoresize_max_height = parseInt(
        editor.getParam("autoresize_max_height", 0),
        10,
      );
